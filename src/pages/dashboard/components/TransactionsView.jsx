        ...
        if (data) {
          Object.keys(data).forEach((key) => {
            ...
            loadedTransactions.push({
              ...
              date: datePart,
              time: timePart,
              customer: `User ${transaction.userID || 'N/A'}`, 
              amount: transaction.amount,
              type: transaction.mode, 
              transactionType: transaction.type, 
              status: 'completed', 
              items: 'Notes Transaction' 
            });
          });
        }
          ...
          <table className="w-full">
            <thead className="bg-dark-bg-tertiary border-b border-dark-border-primary">
              <tr>
                ...
                <th className="text-left py-4 px-6 font-semibold text-dark-text-primary">Mode</th>
                <th className="text-left py-4 px-6 font-semibold text-dark-text-primary">Type</th>
